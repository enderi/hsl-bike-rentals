...
export class CustomMarker {
    ...
    public static of(station: StationInfo): CustomMarker {
        ...
        const marker = L.circleMarker({ lat: station.info.lat, lng: station.info.lng }, props);
    ...
    private static calculateProps(station: StationInfo): L.CircleMarkerOptions {
        ...
        const props: L.CircleMarkerOptions = { radius, color, fillColor: color, opacity: 1, fillOpacity: 0.5, weight}
        return props;
    }
